...
Route::prefix('students')->group(function () {
    ...
    Route::get('update/{student}', 'App\Http\Controllers\StudentController@update')->name('student.update')->middleware("auth");
...
Route::prefix('schools')->group(function () {
    ...
    Route::get('update/{school}', 'App\Http\Controllers\SchoolController@update')->name('school.update')->middleware("auth");
...
Route::prefix('attendanceGroup')->group(function () {
    ...
    Route::get('update/{attendanceGroup}', 'App\Http\Controllers\AttendanceGroupController@update')->name('attendanceGroup.update')->middleware("auth");
